...
with DAG(
    dag_id="ags_web_search",
    description="Fetch agricultural commodity news via Perplexity and summarise with Claude",
    start_date=datetime(2026, 3, 27),
    schedule_interval="0 * * * *",  # every hour
    catchup=False,
    default_args=default_args,
    tags=["commodity-news-tracker", "agriculture", "web"],
) as dag:
